    ...
    class userDAL
    {
        ...
        public bool Insert(userBLL u)
        {
            ...
            try
            {
                ...
                //If the query is executed suucessfully then the value to rows will be greater than 0 else it will be less than 0
                if(rows>0)
                {
                    //Query successful
                    isSuccess = true;
        ...
        public SqlConnection connString { get; set; }
